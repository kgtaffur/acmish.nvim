local M = {}
local config = require("acmish.config")

local function set_highlights()
	local utilities = require("acmish.utilities")
	local palette = require("acmish.palette")
	...
	local default_highlights = {
		...
		SignAdd = { fg = palette.pine, bg = "NONE" },
		SignChange = { fg = palette.iris, bg = "NONE" },
	...
	if config.options.enable.terminal then
		...
		augroup acmish
			...
			autocmd ColorSchemePre * autocmd! acmish
		augroup END
		]])
	end
end
